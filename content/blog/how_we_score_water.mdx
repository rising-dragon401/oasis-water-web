...
Every filter is oftent a compination of activated carbon, reverse osmosis, distillation, uv treatment, ion exchange, chemical disinfection, sedimentation and ozone treatment.

We penalize filters for the number of unique contaminants they don't remove. However it's important to note that your water may not require a filter that remobes every single contaminant.

Penalties:

- Contaminants not removed: 1.5 per contaminant
